...
export default function HomePage() {
    ...
    return (
        ...
        {/* IMAGE */}
        <div className="absolute inset-0 md:relative md:w-[65%] md:h-full">
            <Image
            src="/kampus3.png"
            alt="Kampus"
            fill
            priority
            className="object-cover object-[center_top] md:object-left"
            />

            {/* overlay (mobile biar teks kebaca) */}
        ...
        {/* MOBILE */}
        <div className="md:hidden absolute bottom-0 left-0 w-full bg-white rounded-t-3xl p-6 shadow-2xl">
